...
class TestConfig:
    ...
    This class contains three test methods, one for checking the presence of keys in a configuration file with
    resources, other for checking the presence of keys in a configuration file without resources, and another to
    check if FileNotFoundError is raised if file does not exist.
    """
